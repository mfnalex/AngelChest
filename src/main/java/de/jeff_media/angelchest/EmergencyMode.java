...
public final class EmergencyMode {
    ...
    public static final String[] FREE_VERSION_INSTALLED = {"§c ",
            "§c§l! ! ! W A R N I N G ! ! !",
            "§c ",
            "§cYou have installed AngelChest " + Main.getInstance().getDescription().getVersion() + " but did not remove the old version. The plugin will not work correctly until you remove the old .jar file. Make sure to properly RESTART (NOT RELOAD) your server afterwards! You do NOT have to remove the old AngelChest config folder, it gets updated automatically.",
            "§c",
            "§c(This message is only shown to server operators)"};
    public static final String[] UNSUPPORTED_MC_VERSION_1_13 = {"§c ",
            "§c§l! ! ! W A R N I N G ! ! !",
            "§c ",
            "§cAngelChest " + Main.getInstance().getDescription().getVersion() + " is only compatible with Minecraft versions 1.14.1 and newer. Please use AngelChest version 2.22.2 for Minecraft 1.12.X - 1.13.2:",
            "§c ",
