...
public class AngelChestCommandUtils {
	...
	protected static AngelChest argIdx2AngelChest(Main main, Player sendTo, Player affectedPlayer, String[] args) {
	...
	protected static void teleportPlayerToChest(Main main, Player p, AngelChest ac, CommandSender sender, String[] args) {
	...
	protected static void unlockSingleChest(Main main, Player sendTo, Player affectedPlayer, AngelChest ac) {
//		if(!p.hasPermission("angelchest.tp")) {
...
//		}
	...
	protected static void sendListOfAngelChests(Main main, Player sendTo, Player affectedPlayer) {
		// Get all AngelChests by this player
		ArrayList<AngelChest> angelChestsFromThisPlayer = Utils.getAllAngelChestsFromPlayer(affectedPlayer, main);
	...
	protected static void unlockAllChests(Main main, Player p) {
